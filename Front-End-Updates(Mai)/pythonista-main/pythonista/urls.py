...
from tutorial.urls import tutorial
...
urlpatterns = [
    ...
    path('',user_views.logout_view, name="logout"),
    ...
    path('password_reset/done',auth_views.PasswordResetDoneView.as_view(template_name="user_auth/password_reset_done.html"), name="password_reset_done"),
    path('password_reset-confirm/<uidb64>/<token>/',auth_views.PasswordResetConfirmView.as_view(template_name="user_auth/password_reset_confirm.html"), name="password_reset_confirm"),
